...
#
#         Project: lcls-plc-hxr-vhs.tsproj
#        PLC name: plc_vhs_01 (plc_vhs_01 Instance)
# Generated using: pytmc 2.18.2
# Project version: unknown
#    Project hash: unknown
#     PLC IP/host: 172.21.148.130
#      PLC Net ID: 172.21.148.130.1.1
...
epicsEnvSet("LOCATION", "PLC:plc_vhs_01" )
...
epicsEnvSet("IPADDR",           "172.21.148.130")
epicsEnvSet("AMSID",            "172.21.148.130.1.1")
epicsEnvSet("AMS_PORT",         "851")
epicsEnvSet("ADS_MAX_PARAMS",   "1673")
...
system("${ADS_IOC_TOP}/scripts/add_route.sh 172.21.148.130 ^172.*$")
...
epicsEnvSet("PREFIX",         "PLC:plc_vhs_01:")
...
epicsEnvSet("MOTOR_PREFIX",    "HXR:VHS:MMS:")
epicsEnvSet("MOTOR_NAME",      "CR")
epicsEnvSet("DESC",            "Main.M1 / M1 - CR")
epicsEnvSet("EGU",             "mm")
epicsEnvSet("PREC",            "3")
...
epicsEnvSet("MOTOR_PREFIX",    "HXR:VHS:MMS:")
epicsEnvSet("MOTOR_NAME",      "CRM1")
epicsEnvSet("DESC",            "Main.M2 / M2 - CRM1")
epicsEnvSet("EGU",             "mm")
epicsEnvSet("PREC",            "3")
epicsEnvSet("AXISCONFIG",      "")
epicsEnvSet("ECAXISFIELDINIT", "")
...
epicsEnvSet("MOTOR_PREFIX",    "HXR:VHS:MMS:")
epicsEnvSet("MOTOR_NAME",      "CRM2")
epicsEnvSet("DESC",            "Main.M3 / M3 - CRM2")
epicsEnvSet("EGU",             "mm")
epicsEnvSet("PREC",            "3")
epicsEnvSet("AXISCONFIG",      "")
epicsEnvSet("ECAXISFIELDINIT", "")
...
epicsEnvSet("MOTOR_PREFIX",    "HXR:VHS:MMS:")
epicsEnvSet("MOTOR_NAME",      "CRM3")
epicsEnvSet("DESC",            "Main.M4 / M4 - CRM3")
epicsEnvSet("EGU",             "mm")
epicsEnvSet("PREC",            "3")
epicsEnvSet("AXISCONFIG",      "")
epicsEnvSet("ECAXISFIELDINIT", "")
...
epicsEnvSet("MOTOR_PREFIX",    "HXR:VHS:MMS:")
epicsEnvSet("MOTOR_NAME",      "CRM4")
epicsEnvSet("DESC",            "Main.M5 / M5 - CRM4")
epicsEnvSet("EGU",             "mm")
epicsEnvSet("PREC",            "3")
epicsEnvSet("AXISCONFIG",      "")
epicsEnvSet("ECAXISFIELDINIT", "")
...
epicsEnvSet("MOTOR_PREFIX",    "HXR:VHS:MMS:")
epicsEnvSet("MOTOR_NAME",      "CRR1")
epicsEnvSet("DESC",            "Main.M6 / M6 - CRR1")
epicsEnvSet("EGU",             "mm")
epicsEnvSet("PREC",            "3")
epicsEnvSet("AXISCONFIG",      "")
epicsEnvSet("ECAXISFIELDINIT", "")
...
epicsEnvSet("MOTOR_PREFIX",    "HXR:VHS:MMS:")
epicsEnvSet("MOTOR_NAME",      "CRR2")
epicsEnvSet("DESC",            "Main.M7 / M7 - CRR2")
epicsEnvSet("EGU",             "mm")
epicsEnvSet("PREC",            "3")
epicsEnvSet("AXISCONFIG",      "")
epicsEnvSet("ECAXISFIELDINIT", "")
...
epicsEnvSet("MOTOR_PREFIX",    "HXR:VHS:MMS:")
epicsEnvSet("MOTOR_NAME",      "CRR3")
epicsEnvSet("DESC",            "Main.M8 / M8 - CRR3")
epicsEnvSet("EGU",             "mm")
epicsEnvSet("PREC",            "3")
epicsEnvSet("AXISCONFIG",      "")
epicsEnvSet("ECAXISFIELDINIT", "")
...
epicsEnvSet("MOTOR_PREFIX",    "HXR:VHS:MMS:")
epicsEnvSet("MOTOR_NAME",      "CRR4")
epicsEnvSet("DESC",            "Main.M9 / M9 - CRR4")
epicsEnvSet("EGU",             "mm")
epicsEnvSet("PREC",            "3")
epicsEnvSet("AXISCONFIG",      "")
epicsEnvSet("ECAXISFIELDINIT", "")
...
epicsEnvSet("MOTOR_PREFIX",    "HXR:VHS:MMS:")
epicsEnvSet("MOTOR_NAME",      "CRT1")
epicsEnvSet("DESC",            "Main.M10 / M10 - CRT1")
epicsEnvSet("EGU",             "mm")
epicsEnvSet("PREC",            "3")
epicsEnvSet("AXISCONFIG",      "")
epicsEnvSet("ECAXISFIELDINIT", "")
...
epicsEnvSet("MOTOR_PREFIX",    "HXR:VHS:MMS:")
epicsEnvSet("MOTOR_NAME",      "CRT2")
epicsEnvSet("DESC",            "Main.M11 / M11 - CRT2")
epicsEnvSet("EGU",             "mm")
epicsEnvSet("PREC",            "3")
epicsEnvSet("AXISCONFIG",      "")
epicsEnvSet("ECAXISFIELDINIT", "")
...
epicsEnvSet("MOTOR_PREFIX",    "HXR:VHS:MMS:")
epicsEnvSet("MOTOR_NAME",      "CRT3")
epicsEnvSet("DESC",            "Main.M12 / M12 - CRT3")
epicsEnvSet("EGU",             "mm")
epicsEnvSet("PREC",            "3")
epicsEnvSet("AXISCONFIG",      "")
epicsEnvSet("ECAXISFIELDINIT", "")
...
epicsEnvSet("MOTOR_PREFIX",    "HXR:VHS:MMS:")
epicsEnvSet("MOTOR_NAME",      "CRT4")
epicsEnvSet("DESC",            "Main.M13 / M13 - CRT4")
epicsEnvSet("EGU",             "mm")
epicsEnvSet("PREC",            "3")
epicsEnvSet("AXISCONFIG",      "")
epicsEnvSet("ECAXISFIELDINIT", "")
...
epicsEnvSet("MOTOR_PREFIX",    "HXR:VHS:MMS:")
epicsEnvSet("MOTOR_NAME",      "PRX")
epicsEnvSet("DESC",            "Main.M14 / M14 - PRX")
epicsEnvSet("EGU",             "mm")
epicsEnvSet("PREC",            "3")
epicsEnvSet("AXISCONFIG",      "")
epicsEnvSet("ECAXISFIELDINIT", "")
...
epicsEnvSet("MOTOR_PREFIX",    "HXR:VHS:MMS:")
epicsEnvSet("MOTOR_NAME",      "PRY")
epicsEnvSet("DESC",            "Main.M15 / M15 - PRY")
epicsEnvSet("EGU",             "mm")
epicsEnvSet("PREC",            "3")
epicsEnvSet("AXISCONFIG",      "")
epicsEnvSet("ECAXISFIELDINIT", "")
...
dbLoadRecords("iocSoft.db", "IOC=PLC:plc_vhs_01")
dbLoadRecords("save_restoreStatus.db", "P=PLC:plc_vhs_01:")
dbLoadRecords("caPutLog.db", "IOC=$(IOC)")

## TwinCAT task, application, and project information databases ##
dbLoadRecords("TwinCAT_TaskInfo.db", "PORT=$(ASYN_PORT),PREFIX=PLC:plc_vhs_01,IDX=1,TASK_PORT=350")
dbLoadRecords("TwinCAT_AppInfo.db", "PORT=$(ASYN_PORT), PREFIX=PLC:plc_vhs_01")

dbLoadRecords("TwinCAT_Project.db", "PREFIX=PLC:plc_vhs_01,PROJECT=lcls-plc-hxr-vhs.tsproj,HASH=unknown,VERSION=unknown,PYTMC=2.18.2,PLC_HOST=172.21.148.130")

#   lcls-twincat-motion: * -> 4.2.0 (SLAC)
dbLoadRecords("TwinCAT_Dependency.db", "PREFIX=PLC:plc_vhs_01,DEPENDENCY=lcls-twincat-motion,VERSION=4.2.0,VENDOR=SLAC")
#   Tc2_Standard: * -> 3.4.5.0 (Beckhoff Automation GmbH)
dbLoadRecords("TwinCAT_Dependency.db", "PREFIX=PLC:plc_vhs_01,DEPENDENCY=Tc2_Standard,VERSION=3.4.5.0,VENDOR=Beckhoff Automation GmbH")
#   Tc2_System: * -> 3.9.1.0 (Beckhoff Automation GmbH)
dbLoadRecords("TwinCAT_Dependency.db", "PREFIX=PLC:plc_vhs_01,DEPENDENCY=Tc2_System,VERSION=3.9.1.0,VENDOR=Beckhoff Automation GmbH")
#   Tc3_Module: * -> 3.4.5.0 (Beckhoff Automation GmbH)
dbLoadRecords("TwinCAT_Dependency.db", "PREFIX=PLC:plc_vhs_01,DEPENDENCY=Tc3_Module,VERSION=3.4.5.0,VENDOR=Beckhoff Automation GmbH")

cd "$(IOC_TOP)"

## PLC Project Database files ##
dbLoadRecords("plc_vhs_01.db", "PORT=$(ASYN_PORT),PREFIX=PLC:plc_vhs_01:,IOCNAME=$(IOC),IOC=$(IOC)")

# Total records: 673
callbackSetQueueSize(3346)

# Autosave and archive settings:
save_restoreSet_status_prefix("PLC:plc_vhs_01:")
